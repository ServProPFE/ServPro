        ...
        {!loading && !error && notifications.map((notification) => {
          ...
          return (
            <article
              ...
              className={`rounded-xl border p-3 text-sm ${isUnread ? 'border-teal-300 bg-teal-50/60' : 'border-slate-200 bg-white'}`}
            >
              ...
              {isUnread ? (
                <button
                  ...
                  className="mt-2 rounded-full bg-sky-600 px-3 py-1 text-xs font-semibold text-white transition hover:bg-sky-700 disabled:cursor-not-allowed disabled:bg-slate-300"
                >
