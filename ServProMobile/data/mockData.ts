...
export const mockServices: ServiceItem[] = [
  {
    ...
    category: 'PLOMBERIE',
    description: 'serviceDescriptions.waterLeakRepair',
    priceMin: 45,
    currency: 'TND',
    duration: 60,
  },
  {
    ...
    description: 'serviceDescriptions.electricalInstallation',
    priceMin: 55,
    currency: 'TND',
    duration: 75,
  },
  {
    ...
    description: 'serviceDescriptions.acMaintenance',
    priceMin: 65,
    currency: 'TND',
    duration: 90,
  },
  {
    ...
    category: 'NETTOYAGE',
    description: 'serviceDescriptions.apartmentCleaning',
    priceMin: 40,
    currency: 'TND',
    duration: 120,
  },
...
export const mockOffers: OfferItem[] = [
  {
    ...
    description: 'offerDescriptions.springCleaning',
    discount: 20,
  ...
  },
  {
    ...
    description: 'offerDescriptions.acOffer',
    discount: 15,
