      ...
      <ScrollView contentContainerStyle={styles.content}>
        <View style={styles.headerCard}>
          ...
          <View style={styles.actionsRow}>
            ...
            <Link href="/(tabs)/notifications" dismissTo asChild>
              <Pressable style={({ pressed }) => [styles.closeButton, pressed && styles.actionButtonPressed]}>
          ...
          <View style={styles.summaryRow}>
            ...
            <View style={styles.summaryPillTotal}>
              <Text style={[styles.summaryPillText, styles.summaryPillTextLight]}>
